        ...
        <div style={{ height: "auto" }} className=" bg-white m-auto w-50 text-center rounded p-5">
          ...
          <form action="">
            <div className=' d-flex flex-column'>
              ...
              <TextField
              value={principle||""}
               onChange={(e)=>validateInput(e.target)} name='principle' className=' pb-2' id="outlined-basic" label="Principle Amount" variant="outlined" />
              ...
              <TextField 
              value={rate||""}
              onChange={(e)=>validateInput(e.target)} name='rate' className=' pb-2' id="outlined-basic" label="Rate" variant="outlined" />
              ...
              <TextField
              value={year||""}
               onChange={(e)=>validateInput(e.target)} name='year' className=' pb-2' id="outlined-basic" label="Year" variant="outlined" />
          ...
          <Stack className=' w-100' direction="row" spacing={2}>
            ...
            <Button
            type='submit'
             onClick={handleCalculate} disabled={invalidPrinciple||invaliRate||invalidYear} className=' w-50 p-3 fs-4 bg-success' variant="contained">CALCULATE</Button>
            <Button  className=' w-50 p-3 fs-4 text-danger border-danger' variant="outlined">RESET</Button>
          </Stack>
        </div>
      </div>
    </>
